...
fs.readFile('text2.txt','utf8', function(error, data) {
...
fs.writeFile('new2.txt', message2, function(error) {

    console.log('error: ' + error);
    if (error) throw error;
    let data = fs.readFileSync("new2.txt", "utf8");
...
console.log('async test 2');
 ...
 // SYNC
let file_readed = fs.readFileSync('text.txt', 'utf8'); // read files Sync(синхронно, когда не будет прочитан не вып дальше)
